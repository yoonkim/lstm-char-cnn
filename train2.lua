...
local BatchLoader = require 'util.BatchLoaderUnk'
...
--	         opt.char_vec_size, #loader.idx2char, feature_maps, kernels, loader.max_word_l)
...
function eval_split(split_idx, max_batches, full_eval)
	...
	for t = 1, x:size(2) do
	    local lst = protos.rnn:forward{x[{{},t}],  unpack(rnn_state[0])}
	    rnn_state[0] = {}
